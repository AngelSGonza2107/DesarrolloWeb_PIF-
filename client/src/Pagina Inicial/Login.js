              ...
              <div class="card-body">
                ...
                <form action="" onSubmit={handleSubmit}>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="Ingrese su correo electrónico" 
                  ...
                  <div class="button1">
                    ...
                    <br/>
                    <br/>
                    <Link to="/resetpass" type="button" class="btn">¿Olvidó su contraseña?</Link>
                  </div>
                  <br/>
                  <br/>
                  <div class="button2">
                    <Link to="/signup" class="btn btn-default border">Registrarse</Link>
                  </div>
                </form>
              </div>
            </div>
