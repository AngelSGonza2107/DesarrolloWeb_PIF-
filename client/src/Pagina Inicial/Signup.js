              ...
              <div class="card-body">
                ...
                <form action="" onSubmit={handleSubmit}>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="Ingrese su nombre completo"
                  ...
                  <div class="mb-3">
                    <label for="usuario" class="form-label">Registro Académico</label>
                    <input type="text" class="form-control" id="autoSizingInputGroup" placeholder="Ingrese su registro académico"
                  ...
                  <div class="button1">
                    ...
                    <br/>
                  <div class="button2">
                    <Link to="/" class="btn btn-default border">Iniciar Sesión</Link>
                  </div>
                </form>
              </div>
            </div>
